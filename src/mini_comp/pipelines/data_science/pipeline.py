...
from .nodes import write_output_file, wrapper_split_datasplit_data, wrapper_get_best_model, wrapper_plot_fitted_values
...
def create_pipeline(**kwargs) -> Pipeline:
    return pipeline(
        [
            node(
                func=wrapper_split_datasplit_data,
            ...
            node(
                ...
                inputs=["sj_train", "sj_fitted_model", "iq_train", "iq_fitted_model"],
                outputs=['sj_figs', 'iq_figs'],
                name="plot_fitted_values_node",
            ),
            node(
                func=write_output_file,
                inputs=["sj_test", "iq_test", "sj_best_model", "iq_best_model"],
                outputs="submission",
